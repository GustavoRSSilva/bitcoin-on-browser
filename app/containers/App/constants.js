...
export const SEED_CREATED_STATE = 'seed_created_state';
export const FETCH_SEED_CREATED = `${path}FETCH_SEED_CREATED`;
export const FETCH_SEED_CREATED_REJECTED = `${path}FETCH_SEED_CREATED_REJECTED`;
export const FETCH_SEED_CREATED_SUCCESSFUL = `${path}FETCH_SEED_CREATED_SUCCESSFUL`;
